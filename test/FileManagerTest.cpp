...
void testReadAndWriteChunks() {
    ...
    const streamsize MEGABYTE = Config::KB_SIZE * Config::KB_SIZE;
    streamsize size = (10 * MEGABYTE) + (50 * Config::KB_SIZE); // 10 MB size + 50 KB in last chunk
    ...
    assert(lastChunkSize == 50 * Config::KB_SIZE);
